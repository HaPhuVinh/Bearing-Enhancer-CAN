...
namespace Bearing_Enhancer_CAN
{
    ...
    public class Bearing_Enhancer_VerBlock : Bearing_Enhancer
    {
        ...
        public override string Generate_Enhancer_Note(string chosensolution, string language, string unit)
        {
            ...
            double row = Math.Ceiling(numberFastener / ((blockLength - 2 * Hor_Block.EndDistance) / Hor_Block.MinSpacing + 1)/numberBlock);
            ...
            if (language == "English")
            {
                ...
                {
                    theNote = $"Attach bearing block BB1, {lumSize}x{Hor_Block.BlockLength}{iom.Text} {LumSpecie} #2 (or better), to {(Hor_Block.NumberBlock == 1 ? "one face" : "both face(s)")} of the web #-# w/ {(row <= Hor_Block.MinRow ? Hor_Block.MinRow : row)} {(row > 1 ? "staggered rows" : "row")} of {fasDescription} @ {Hor_Block.MinSpacing}{iom.Text} o.c. {(row > 1 ? "Stagger rows by 1/2 the nails spacing." : ".")} Install a minimum of ({(Hor_Block.NumberBlock == 2 ? (Math.Ceiling(numberFastener * 1.0 / 2)) : numberFastener)}) nails{(Hor_Block.NumberBlock == 2 ? " per block." : ".")}";
                }
                else if (fastenerType.Contains("SDW"))
                {
                    theNote = $"Attach bearing block BB1, {lumSize}x{Hor_Block.BlockLength}{iom.Text} {LumSpecie} #2 (or better), to {(Hor_Block.NumberBlock == 1 ? "one face" : "both face(s)")} of the web #-# w/ {(row <= Hor_Block.MinRow ? Hor_Block.MinRow : row)} {(row > 1 ? "staggered rows" : "row")} of Simpson {fasDescription} @ {Hor_Block.MinSpacing}{iom.Text} o.c. Install the screws per Simpson specifications. Install a minimum of ({(Hor_Block.NumberBlock == 2 ? (Math.Ceiling(numberFastener * 1.0 / 2)) : numberFastener)}) screws{(Hor_Block.NumberBlock == 2 ? " per block." : ".")}";
                }
                else if (fastenerType.Contains("SDS"))
                {
                    theNote = $"Attach bearing block BB1, {lumSize}x{Hor_Block.BlockLength}{iom.Text} {LumSpecie} #2 (or better), to {(Hor_Block.NumberBlock == 1 ? "one face" : "both face(s)")} of the web #-# w/ ({(Hor_Block.NumberBlock == 2 ? (Math.Ceiling(numberFastener * 1.0 / 2)) : numberFastener)}) Simpson {fasDescription}{(Hor_Block.NumberBlock == 2 ? " per block." : ".")} See ICC-ES Report ESR-2236 for minimum spacing, edge distance, and end distance requirements for SDS screws.";
                }
                else { theNote = ""; }
            }
            else
            {
                if (fastenerType.Contains("Nail"))
                {
                    theNote = $"Attachez le renfort d'appui BB1, {lumSize}x{Hor_Block.BlockLength}{iom.Text} {LumSpecie} #2 (ou mieux), sur {(Hor_Block.NumberBlock == 1 ? "une face" : "les deux face(s)")} de la l’âme avec {(row <= Hor_Block.MinRow ? Hor_Block.MinRow : row)} {(row > 1 ? "rangée décalées" : "rangée")} de {fasDescription} @ {Hor_Block.MinSpacing}{iom.Text} c.c. {(row > 1 ? "Le décalage des rangées doit être de 1/2 l'espacement." : ".")} Installez un min de ({(Hor_Block.NumberBlock == 2 ? (Math.Ceiling(numberFastener * 1.0 / 2)) : numberFastener)}) clous{(Hor_Block.NumberBlock == 2 ? " par bloc." : ".")}";
                }
                else if (fastenerType.Contains("SDW"))
                {
                    theNote = $"Attachez le renfort d'appui BB1, {lumSize}x{Hor_Block.BlockLength}{iom.Text} {LumSpecie} #2 (ou mieux), sur {(Hor_Block.NumberBlock == 1 ? "une face" : "les deux face(s)")} de la l’âme avec {(row <= Hor_Block.MinRow ? Hor_Block.MinRow : row)} {(row > 1 ? "rangée décalées" : "rangée")} de vis {fasDescription} de Simpson@ {Hor_Block.MinSpacing}{iom.Text} c.c. Installez les vis selon les spécifications de Simpson. Installez un min. de ({(Hor_Block.NumberBlock == 2 ? (Math.Ceiling(numberFastener * 1.0 / 2)) : numberFastener)}) vis{(Hor_Block.NumberBlock == 2 ? " par bloc." : ".")}";
                }
                else if (fastenerType.Contains("SDS"))
                {
                    theNote = $"Attachez le renfort d'appui BB1, {lumSize}x{Hor_Block.BlockLength}{iom.Text} {LumSpecie} #2 (ou mieux), sur {(Hor_Block.NumberBlock == 1 ? "une face" : "les deux face(s)")} de la l’âme avec ({(Hor_Block.NumberBlock == 2 ? (Math.Ceiling(numberFastener * 1.0 / 2)) : numberFastener)}) vis {fasDescription} de Simpson{(Hor_Block.NumberBlock == 2 ? " par bloc." : ".")} Consultez le rapport d'évaluation ESR-2236 pour les espacements min. d'extrémité et de rive pour les vis SDS.";
                }
                else { theNote = ""; }
            }
            return theNote;
    ...
    public class Bearing_Enhancer_HorBlock : Bearing_Enhancer
    {
        ...
        public override string Generate_Enhancer_Note(string chosensolution, string language, string unit)
        {
            ...
            if (language == "English")
            {
                if (fastenerType.Contains("Nail"))
                {
                    theNote = $"Attach bearing block BB1, {lumSize}x{Hor_Block.BlockLength}{iom.Text} {LumSpecie} #2 (or better), to {(Hor_Block.NumberBlock == 1 ? "one face" : "both face(s)")} of the bottom chord w/ {(row <= Hor_Block.MinRow ? Hor_Block.MinRow : row)} {(row>1 ? "staggered rows" : "row")} of {fasDescription} @ {Math.Round(Hor_Block.MinSpacing*iom.miliFactor)}{iom.Text} o.c. {(row>1? "Stagger rows by 1/2 the nails spacing." : ".")} Install a minimum of ({(Hor_Block.NumberBlock == 2 ? (Math.Ceiling(numberFastener * 1.0 / 2)) : numberFastener)}) nails{(Hor_Block.NumberBlock == 2 ? " per block." : ".")}";
                }
                else if (fastenerType.Contains("SDW"))
                {
                    theNote = $"Attach bearing block BB1, {lumSize}x{Hor_Block.BlockLength}{iom.Text} {LumSpecie} #2 (or better), to {(Hor_Block.NumberBlock == 1 ? "one face" : "both face(s)")} of the bottom chord w/ {(row <= Hor_Block.MinRow ? Hor_Block.MinRow : row)} {(row > 1 ? "staggered rows" : "row")} of Simpson {fasDescription} @ {Math.Round(Hor_Block.MinSpacing * iom.miliFactor)}{iom.Text} o.c. Install the screws per Simpson specifications. Install a minimum of ({(Hor_Block.NumberBlock == 2 ? (Math.Ceiling(numberFastener * 1.0 / 2)) : numberFastener)}) screws{(Hor_Block.NumberBlock == 2 ? " per block." : ".")}";
                }
                else if (fastenerType.Contains("SDS"))
                {
                    theNote = $"Attach bearing block BB1, {lumSize}x{Hor_Block.BlockLength}{iom.Text} {LumSpecie} #2 (or better), to {(Hor_Block.NumberBlock == 1 ? "one face" : "both face(s)")} of the bottom chord w/ ({(Hor_Block.NumberBlock == 2 ? (Math.Ceiling(numberFastener * 1.0 / 2)) : numberFastener)}) Simpson {fasDescription}{(Hor_Block.NumberBlock == 2 ? " per block." : ".")} See ICC-ES Report ESR-2236 for minimum spacing, edge distance, and end distance requirements for SDS screws.";
                }
                else { theNote = ""; }
            }
            else
            {
                if (fastenerType.Contains("Nail"))
                {
                    theNote = $"Attachez le renfort d'appui BB1, {lumSize}x{Hor_Block.BlockLength}{iom.Text} {LumSpecie} #2 (ou mieux), sur {(Hor_Block.NumberBlock == 1 ? "une face" : "les deux face(s)")} de la MI avec {(row <= Hor_Block.MinRow ? Hor_Block.MinRow : row)} {(row>1 ? "rangée décalées" : "rangée")} de {fasDescription} @ {Math.Round(Hor_Block.MinSpacing * iom.miliFactor)}{iom.Text} c.c. {(row>1 ? "Le décalage des rangées doit être de 1/2 l'espacement." : ".")} Installez un min de ({(Hor_Block.NumberBlock == 2 ? (Math.Ceiling(numberFastener * 1.0 / 2)) : numberFastener)}) clous{(Hor_Block.NumberBlock == 2 ? " par bloc." : ".")}";
                }
                else if (fastenerType.Contains("SDW"))
                {
                    theNote = $"Attachez le renfort d'appui BB1, {lumSize}x{Hor_Block.BlockLength}{iom.Text} {LumSpecie} #2 (ou mieux), sur {(Hor_Block.NumberBlock == 1 ? "une face" : "les deux face(s)")} de la MI avec {(row <= Hor_Block.MinRow ? Hor_Block.MinRow : row)} {(row > 1 ? "rangée décalées" : "rangée")} de vis {fasDescription} de Simpson@ {Math.Round(Hor_Block.MinSpacing * iom.miliFactor)}{iom.Text} c.c. Installez les vis selon les spécifications de Simpson. Installez un min. de ({(Hor_Block.NumberBlock == 2 ? (Math.Ceiling(numberFastener * 1.0 / 2)) : numberFastener)}) vis{(Hor_Block.NumberBlock == 2 ? " par bloc." : ".")}";
                }
                else if (fastenerType.Contains("SDS"))
                {
                    theNote = $"Attachez le renfort d'appui BB1, {lumSize}x{Hor_Block.BlockLength}{iom.Text} {LumSpecie} #2 (ou mieux), sur {(Hor_Block.NumberBlock == 1 ? "une face" : "les deux face(s)")} de la MI avec ({(Hor_Block.NumberBlock == 2 ? (Math.Ceiling(numberFastener * 1.0 / 2)) : numberFastener)}) vis {fasDescription} de Simpson{(Hor_Block.NumberBlock == 2 ? " par bloc." : ".")} Consultez le rapport d'évaluation ESR-2236 pour les espacements min. d'extrémité et de rive pour les vis SDS.";
                }
                else { theNote = ""; }
            }
            return theNote;
