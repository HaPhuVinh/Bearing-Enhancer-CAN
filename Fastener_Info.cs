...
namespace Bearing_Enhancer_CAN
{
    ...
    public class Fastener_Lateral_Design_Value
    {
        ...
        //public (string Type, int SP, int DFL, int HF, int SPF, double APF) SDW22300_Screw { get; set; }
        //    = ("SDW22300 Screw [.22\"x3\"]", 355, 355, 290, 290, 6.6);
        //public (string Type, int SP, int DFL, int HF, int SPF, double APF) SDW22458_Screw { get; set; }
        //    = ("SDW22458 Screw [.22\"x4 5/8\"]", 455, 455, 405, 405, 6.6);
        //public (string Type, int SP, int DFL, int HF, int SPF, double APF) SDW22638_Screw { get; set; }
        //    = ("SDW22638 Screw [.22\"x6 3/8\"]", 455, 455, 405, 405, 6.6);
        //public (string Type, int SP, int DFL, int HF, int SPF, double APF) SDS25300_Screw { get; set; }
        //    = ("SDS25300 Screw [.25\"x3\"]", 370, 370, 320, 320, 5.0);
        //public (string Type, int SP, int DFL, int HF, int SPF, double APF) SDS25412_Screw { get; set; }
        //    = ("SDS25412 Screw [.25\"x4 1/2\"]", 475, 475, 420, 420, 5.0);
        //public (string Type, int SP, int DFL, int HF, int SPF, double APF) SDS25600_Screw { get; set; }
        //    = ("SDS25600 Screw [.25\"x6\"]", 475, 475, 420, 420, 5.0);
        //public (string Type, int SP, int DFL, int HF, int SPF, double APF) Gun_Nails { get; set; }
